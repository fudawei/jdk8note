...
public class ThreadPoolExecutor extends AbstractExecutorService {
    ...
    /**
     * 主线程池控制状态　　是一个原子integer类型的变量,代表一下两个数量
     * workerCount 　有效线程数 　　
     * runState      线程状态（running shutdown....）
     */
     ...
     *
     *  限制线程等待执行任务的超时时间（纳秒）
     *  当线程数大于核心线程（corePoolSize） 或者（allowCoreThreadTimeOut）为true,
     *  否则一直等待任务
     */
     ...
     * for work.
     *  如果为true, 核心线程用存活时间（keepAliveTime）等待超时
     *  如果为false (默认)， 核心线程一直活着即便是闲置状态
     */
